...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_voyager(
    CW_TOGG,        KC_1,           KC_2,           KC_3,           KC_4,           KC_5,                                           KC_6,           KC_7,           KC_8,           KC_9,           KC_0,           KC_EQUAL,       
    KC_GRAVE,       KC_B,           MT(MOD_LGUI, KC_L),MT(MOD_LALT, KC_D),MT(MOD_LCTL, KC_W),KC_Z,                                           KC_QUOTE,       MT(MOD_RCTL, KC_F),MT(MOD_LALT, KC_O),MT(MOD_RGUI, KC_U),KC_J,           KC_SCLN,        
    MT(MOD_LSFT, KC_BSLS),LT(4,KC_N),     LT(3,KC_R),     LT(1,KC_T),     LT(2,KC_S),     KC_G,                                           KC_Y,           LT(2,KC_H),     LT(1,KC_A),     LT(3,KC_E),     LT(4,KC_I),     MT(MOD_RSFT, KC_COMMA),
    OSM(MOD_LALT),  KC_Q,           MT(MOD_RALT, KC_X),KC_M,           KC_C,           KC_V,                                           KC_K,           KC_P,           KC_DOT,         MT(MOD_RALT, KC_MINUS),KC_SLASH,       OSM(MOD_RALT),  
  ...
  [1] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, KC_0,           KC_1,           KC_2,           KC_3,           KC_DOT,                                         KC_MS_BTN2,     KC_MS_BTN1,     KC_MS_WH_DOWN,  KC_MS_WH_UP,    KC_ENTER,       KC_INSERT,      
...
const key_override_t unds_key_override =
    ko_make_with_layers(MOD_MASK_SHIFT, KC_QUOT, KC_MINS, 1);
const key_override_t ques_key_override =
    ko_make_with_layers(MOD_MASK_SHIFT, KC_COMM, KC_SLSH, 1);
const key_override_t lt_key_override =
    ko_make_with_layers(MOD_MASK_SHIFT, KC_SLSH, KC_COMM, 1);
const key_override_t dquo_key_override =
    ko_make_with_layers(MOD_MASK_SHIFT, KC_MINS, KC_QUOT, 1);
